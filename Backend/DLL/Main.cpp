...
void __stdcall MainThread(LPVOID lpParam)
{
	...
	//CopyFile("C:\\vos\\undefeated.ttf", "C:\\Windows\\Fonts\\undefeated.ttf", 0);
	AddFontResource("C:\\vos\\undefeated.ttf");
	...
	/*if (Cheat::Settings->ShowConsole)
		Cheat::Utilities->Console_Create(xorstr_("vos BETA"));
	//LoadLibraryA(xorstr_("mscorlib.dll"));
	...
	CreateDirectory("C:/vos/", NULL);
	CreateDirectory("C:/vos/cfg/", NULL);
	CreateDirectory("C:/vos/lua/", NULL);
